 ...
 */
   function exec() {
	...
	jsonDoc["data"] = createInvoiceTransactions(tableAccounts, userParam.invoiceNumber, userParam.accountRevenue, userParam.invoiceText);
...
function createInvoiceTransactions(accounts_table, invoiceNumber, accountRevenue, description) {
